...
import { ArrowLeft, Save, Download, Instagram, Music2, Video, CheckCircle2, AlertCircle } from "lucide-solid";
...
function TrackSettingsPage() {
  ...
  const [instagram, setInstagram] = createSignal(existingSocialPrompt().instagram || "");
  const [soundcloud, setSoundcloud] = createSignal(existingSocialPrompt().soundcloud || "");
    ...
    try {
      ...
      await updateTrackSettings({
        data: {
          ...
          socialPrompt: Object.keys(socialPrompt).length > 0 ? socialPrompt : undefined,
        },
      });
        ...
        <form onSubmit={handleSubmit} class="space-y-8">
            ...
            <label class="flex items-start gap-4 cursor-pointer">
              ...
              <div>
                ...
                <p class="text-small mt-1">
                  When enabled, users can download the original quality version of this track.
                </p>
              </div>
            </label>
          </section>
          ...
          <section class="card p-6">
            ...
            <p class="text-small mb-6">
              Optionally prompt users to follow your social accounts before downloading.
              Leave empty to skip.
            </p>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <span class="absolute left-3 top-1/2 -translate-y-1/2 text-surface-400 text-sm">soundcloud.com/</span>
                  <input
                    type="text"
                    value={soundcloud()}
