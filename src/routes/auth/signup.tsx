...
import { Mail, Lock, User, Ticket, UserPlus, AlertCircle, CheckCircle2 } from "lucide-solid";
        ...
        <div class="card p-8">
          ...
          <Show when={inviteCode()}>
            <div class="flex items-center gap-2 p-3 bg-accent-50 dark:bg-accent-950 text-accent-600 dark:text-accent-400 rounded-xl mb-6 animate-scale-in">
              ...
              <p class="text-sm">Invite code applied! You'll get special access.</p>
            </div>
          </Show>
          ...
          <form onSubmit={handleSubmit} class="space-y-4">
            ...
            <button
              ...
              disabled={loading()}
            >
              <Show when={!loading()} fallback={<span>Creating account...</span>}>
